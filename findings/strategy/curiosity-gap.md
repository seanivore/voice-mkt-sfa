...
1. **Information gaps** create cognitive tension that people are motivated to resolve
2. **Exclusivity** ("most people haven't heard about this yet") triggers FOMO (Fear Of Missing Out)
3. **Micro-commitments** leverage the consistency principle—people tend to remain consistent with prior actions
4. **Low-pressure requests** bypass defensive reactions while maintaining engagement
...
1. **Craft curiosity-triggering openings that:**
...
4. **Adjust voice tone and pacing to enhance curiosity:**
