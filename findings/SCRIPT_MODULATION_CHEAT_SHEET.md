...
| ------------------- | ------------------------------- | --------------------------------------------------------------- |
| **Emphasis**        | ALL CAPS for key words          | "This offer is ONLY available today"                            |
| **Emphasis**        | *Italics* for moderate emphasis | "This is *really* important to note"                            |
| **Emphasis**        | **Bold** for strong emphasis    | "We **guarantee** results"                                      |
| **Short Pause**     | Use commas                      | "Hello, this is Sarah, calling from Johnson Plumbing."          |
| **Medium Pause**    | Use ellipses (...)              | "Let me check that for you... I see your account now."          |
| **Long Pause**      | [pause] or [p]                  | "Before I continue [pause] I need to confirm your information." |
| **Paragraph Break** | Use for topic changes           | Creates natural longer pauses between sections                  |

## Tone and Pace Indicators

| Modulation         | Formatting                 | Example                                                        |
| ------------------ | -------------------------- | -------------------------------------------------------------- |
| **Friendly Tone**  | [friendly] or !            | "[friendly] Great to hear from you again!"                     |
| **Serious Tone**   | [serious]                  | "[serious] This matter requires immediate attention."          |
| **Excited Tone**   | [excited] or !!!           | "[excited] We've just launched an amazing new feature!!!"      |
| **Concerned Tone** | [concerned]                | "[concerned] I noticed some unusual activity on your account." |
| **Fast Pace**      | [fast] or short sentences  | "[fast] Quick update. New features ready. Launch next week."   |
| **Slow Pace**      | [slow] or longer sentences | "[slow] I'd like to take a moment to explain how this works."  |

## Pitch and Inflection Techniques

| Technique              | Formatting               | Example                                           |
| ---------------------- | ------------------------ | ------------------------------------------------- |
| **Low Pitch**          | [low] or [130Hz]         | "[low] This is a limited-time offer."             |
| **High Pitch**         | [high] or [180Hz]        | "[high] Wouldn't that be perfect for your needs?" |
| **Rising Inflection**  | ? or [rising]            | "That sounds good[rising]" or "That sounds good?" |
| **Falling Inflection** | [falling] or period      | "This solution will save you time[falling]"       |
| **Questioning Tone**   | ? at end of statement    | "You mentioned having issues with your service?"  |
| **Declarative Tone**   | Period, direct statement | "This will solve your problem."                   |
