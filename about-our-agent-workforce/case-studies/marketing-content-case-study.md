```yaml
---
title: "Automating AI to Create Impressive Marketing Plan"
...
The **"[Brand Identity Briefings](../../../marketing-agent-case-study/brand-identity-briefings.md)"** took less than five minutes to gather. The information found online was pasted directly into text documents and placed in a folder on the computer. Each brand identity overview you can see is very short but informative, the three used have an average of just 210 words. The AI choose the following brands from the list. 
