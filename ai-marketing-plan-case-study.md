...
The **"[Brand Identity Briefings](./ai-marketing-plan-case-study/brand-identity-briefings.md)"** took less than five minutes to gather. The information found online was pasted directly into text documents and placed in a folder on the computer. Each brand identity overview you can see is very short but informative, the three used have an average of just 210 words. The AI choose the following brands from the list. 
...
1. **[Content Plan](./ai-marketing-plan-case-study/content-plan.md)**
...
- [Content Planning Configuration File](./ai-marketing-plan-case-study/content-plan/agent-configuration-prompt-input.md)

2. **[Email Campaign](./ai-marketing-plan-case-study/email-blast.md)**
...
- [Email Campaign Configuration File](./ai-marketing-plan-case-study/email-blast/ai-prompt-configuration-agent.md)

3. **[Instagram Post](./ai-marketing-plan-case-study/instagram-post.md)**
...
- [Instagram Post Configuration File](./ai-marketing-plan-case-study/instagram-post/instagram-post-agentic-configuration.md)
...
**[Content Plan For All Brands](./ai-marketing-plan-case-study/content-plan/production-flow-content-plan.md)** 

**[Email Campaign For All Brands](./ai-marketing-plan-case-study/email-blast/production-flow-email-blast.md)**

**[Instagram Post For All Brands](./ai-marketing-plan-case-study/instagram-post/production-flow-instagram-posts.md)**
...
**[Content Plan for Glossier](./ai-marketing-plan-case-study/content-plan/glossier-content-plan.md)** 
...
**[Email Campaign for Glossier](./ai-marketing-plan-case-study/email-blast/glossier-email-campaign.md)**
...
**[Instagram Post for Glossier](./ai-marketing-plan-case-study/instagram-post/glossier-instagram-posts.md)**
...
**[Content Plan for Hydro Flask](./ai-marketing-plan-case-study/content-plan/hydro-flask-content-plan.md)**

**[Email Campaign for Hydro Flask](./ai-marketing-plan-case-study/email-blast/hydro-flask-email-campaign.md)**

**[Instagram Post for Hydro Flask](./ai-marketing-plan-case-study/instagram-post/hydro-flask-instagram-posts.md)**
...
**[Content Plan for Jungalow](./ai-marketing-plan-case-study/content-plan/jungalow-content-plan.md)**
